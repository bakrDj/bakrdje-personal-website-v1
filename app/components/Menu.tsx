  ...
  return (
    <>
      <div className="w-[1200px] m-auto ">
        <div className="relative z-[9999] w-full text-[#113946] flex justify-center">
          <nav
            className="py-6"
            id="menu"
          >
            <ul className="flex gap-3 items-center text-xl font-medium  ">
              <Link href="/me">
                <li
                  onClick={() => {
              ...
              <Link href="/projects">
                <li
                  ...
                  className={` flex gap-3 items-center justify-center ${pathname === "/projects" ? "active" : ""} `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
